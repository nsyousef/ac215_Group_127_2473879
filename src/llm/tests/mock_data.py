...
MOCK_ANSWER1 = (
    "It typically takes 2-4 weeks for the skin to heal, but it can vary depending on the severity of the condition."
)
...
MOCK_METADATA = {
    ...
    "history": {
        "2025-10-10": {
            "cv_analysis": {"area": 12.6, "color_profile": {"redness_index": 0.46}},
            "text_summary": "Patient reported increased redness and itching.",
        },
        "2025-11-01": {
            "cv_analysis": {"area": 9.8, "color_profile": {"redness_index": 0.38}},
            "text_summary": "Slight improvement noted.",
        },
    },
}
