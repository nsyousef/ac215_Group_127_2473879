...
class MultimodalClassifier(nn.Module):
    ...
    def __init__(self, config: Dict[str, Any]):
        ...
        if self.fusion_strategy not in ['weighted_sum', 'concat_mlp']:
            raise ValueError(f"Unsupported fusion strategy: {self.fusion_strategy}. Must be 'weighted_sum' or 'concat_mlp'")
    ...
    def _build_projection(self, input_dim: int, hidden_sizes: list, output_dim: int,
    ...
    def get_model_info(self) -> Dict[str, Any]:
        ...
        if self.fusion_strategy == 'weighted_sum':
            info['fusion_weights'] = {
                'alpha_vision': self.alpha_vision.item(),
                'alpha_text': self.alpha_text.item()
            }
